# Welcome, trans-mon-hackers, to the 2025 TDI Global Hackathon!
...
| **GitHub**        | [Repo](https://github.com/db-hackathon/trans-mon-hackers)                                                                             | Your team's code repository.                                            |
| **Terraform Cloud** | [Workspace](https://app.terraform.io/app/db-hackathon-2025/workspaces/hack-team-trans-mon-hackers)                                            | Optional Infrastructure as Code for GCP.                                |
| **OpenShift**     | [Console](https://console-openshift-console.apps.hackathon.francecentral.aroapp.io/k8s/cluster/projects/trans-mon-hackers-official) | Optional container platform for deployments.                            |
...
*   **RedHat OpenShift:** Visit the [OpenShift Console](https://console-openshift-console.apps.hackathon.francecentral.aroapp.io/k8s/cluster/projects/trans-mon-hackers-official) and select **AAD** to log in.
...
Infrastructure SA (`infrastructure@hack-team-trans-mon-hackers.iam.gserviceaccount.com` Use this for deploying resources from GitHub Actions or Terraform Cloud. It has the same permissions as a human team member.

Workload SA (`workload@hack-team-trans-mon-hackers.iam.gserviceaccount.com`): Attach this to your compute resources (e.g., Cloud Run, Cloud Functions). It has the following roles:
...
* vars.APP_ENGINE_DEFAULT_SA_EMAIL - The email address of the default App Engine service account.: hack-team-trans-mon-hackers@appspot.gserviceaccount.com
* vars.APP_ENGINE_DEFAULT_SA_ID - The fully qualified name of the default App Engine service account.: projects/hack-team-trans-mon-hackers/serviceAccounts/hack-team-trans-mon-hackers@appspot.gserviceaccount.com
* vars.COMPUTE_DEFAULT_SA_EMAIL - The email address of the default Compute Engine service account.: 670003569156-compute@developer.gserviceaccount.com
* vars.COMPUTE_DEFAULT_SA_ID - The fully qualified name of the default Compute Engine service account.: projects/hack-team-trans-mon-hackers/serviceAccounts/670003569156-compute@developer.gserviceaccount.com
* vars.INFRA_SA_EMAIL - The email address representation of the SA you can use to deploy infrastructure. It has the same access rights as human team members.: infrastructure@hack-team-trans-mon-hackers.iam.gserviceaccount.com
* vars.INFRA_SA_ID - The fully qualified ID representation of the SA you can use to deploy infrastructure.: projects/hack-team-trans-mon-hackers/serviceAccounts/infrastructure@hack-team-trans-mon-hackers.iam.gserviceaccount.com
* vars.OPENSHIFT_NAMESPACE - The OpenShift namespace for your team: trans-mon-hackers-official
...
* vars.PROJECT_ID - Your team's GCP Project ID.: hack-team-trans-mon-hackers
* vars.PROJECT_NUMBER - Your teams' GCP Project Number.: 670003569156
...
* vars.WORKLOAD_SA_EMAIL - The email address representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : workload@hack-team-trans-mon-hackers.iam.gserviceaccount.com
* vars.WORKLOAD_SA_ID - The fully qualified ID representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : projects/hack-team-trans-mon-hackers/serviceAccounts/workload@hack-team-trans-mon-hackers.iam.gserviceaccount.com
...
* app_engine_default_sa_email - The email address of the default App Engine service account.: hack-team-trans-mon-hackers@appspot.gserviceaccount.com
* app_engine_default_sa_id - The fully qualified name of the default App Engine service account.: projects/hack-team-trans-mon-hackers/serviceAccounts/hack-team-trans-mon-hackers@appspot.gserviceaccount.com
* compute_default_sa_email - The email address of the default Compute Engine service account.: 670003569156-compute@developer.gserviceaccount.com
* compute_default_sa_id - The fully qualified name of the default Compute Engine service account.: projects/hack-team-trans-mon-hackers/serviceAccounts/670003569156-compute@developer.gserviceaccount.com
* infra_sa_email - The email address representation of the SA you can use to deploy infrastructure. It has the same access rights as human team members.: infrastructure@hack-team-trans-mon-hackers.iam.gserviceaccount.com
* infra_sa_id - The fully qualified ID representation of the SA you can use to deploy infrastructure.: projects/hack-team-trans-mon-hackers/serviceAccounts/infrastructure@hack-team-trans-mon-hackers.iam.gserviceaccount.com
* openshift_namespace - The OpenShift namespace for your team: trans-mon-hackers-official
...
* project_id - Your team's GCP Project ID.: hack-team-trans-mon-hackers
* project_number - Your teams' GCP Project Number.: 670003569156
...
* workload_sa_email - The email address representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : workload@hack-team-trans-mon-hackers.iam.gserviceaccount.com
* workload_sa_id - The fully qualified ID representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : projects/hack-team-trans-mon-hackers/serviceAccounts/workload@hack-team-trans-mon-hackers.iam.gserviceaccount.com

#### OpenShift :rocket:

*   Your team has a project and namespace named `trans-mon-hackers-official`.
